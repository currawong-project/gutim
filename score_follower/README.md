...
1. A YAML file containing a record for each performed note along with the score 'loc' value which aligns with it.
   This file is stored in the `sf_track` directory.
   
2. A SVG graphic file which shows how the performance matches to the score.
   This file is stored in the `tl` directory.
